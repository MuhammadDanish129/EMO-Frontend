...
function HeaderComponent_div_22_span_3_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r1.unreadAlertCount > 99 ? "99+" : ctx_r1.unreadAlertCount);
  }
}
function HeaderComponent_div_22_div_21_article_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "article", 50)(1, "span", 51);
    \u0275\u0275element(2, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div")(4, "div", 52)(5, "strong");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngClass", ctx_r1.getAlertTone(alert_r3.severity));
    \u0275\u0275advance(2);
    \u0275\u0275classMap(ctx_r1.getAlertIcon(alert_r3.type));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(alert_r3.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.formatAlertTime(alert_r3));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(alert_r3.message);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(alert_r3.applianceName || alert_r3.sensorName);
  }
}
function HeaderComponent_div_22_div_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 48);
    \u0275\u0275template(1, HeaderComponent_div_22_div_21_article_1_Template, 13, 7, "article", 49);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.filteredLiveAlerts)("ngForTrackBy", ctx_r1.trackByAlert);
  }
}
function HeaderComponent_div_22_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 53);
    \u0275\u0275element(1, "i", 54);
    \u0275\u0275elementStart(2, "strong");
    \u0275\u0275text(3, "No alerts right now");
    \u0275\u0275elementEnd()();
  }
}
function HeaderComponent_div_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function HeaderComponent_div_22_Template_button_click_1_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.toggleAlertPanel($event));
    });
    \u0275\u0275element(2, "i", 39);
    \u0275\u0275template(3, HeaderComponent_div_22_span_3_Template, 2, 1, "span", 40);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div", 41);
    \u0275\u0275listener("click", function HeaderComponent_div_22_Template_div_click_4_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.handleAlertPanelClick($event));
    });
    \u0275\u0275elementStart(5, "div", 42)(6, "div")(7, "h3");
    \u0275\u0275text(8, "Operations alerts");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "p");
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(11, "span", 43);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "div", 44)(13, "button", 45);
    \u0275\u0275listener("click", function HeaderComponent_div_22_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAlertFilter("all"));
    });
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "button", 45);
    \u0275\u0275listener("click", function HeaderComponent_div_22_Template_button_click_15_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAlertFilter("critical"));
    });
    \u0275\u0275text(16);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "button", 45);
    \u0275\u0275listener("click", function HeaderComponent_div_22_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAlertFilter("warning"));
    });
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "button", 45);
    \u0275\u0275listener("click", function HeaderComponent_div_22_Template_button_click_19_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.setAlertFilter("info"));
    });
    \u0275\u0275text(20);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(21, HeaderComponent_div_22_div_21_Template, 2, 2, "div", 46)(22, HeaderComponent_div_22_ng_template_22_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const noHeaderAlerts_r4 = \u0275\u0275reference(23);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("has-alerts", ctx_r1.unreadAlertCount > 0);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1.unreadAlertCount > 0);
    \u0275\u0275advance();
    \u0275\u0275classProp("open", ctx_r1.isAlertPanelOpen);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1("", ctx_r1.liveAlertTotal, " active");
    \u0275\u0275advance(3);
    \u0275\u0275classProp("active", ctx_r1.selectedAlertSeverityFilter === "all");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" All ", ctx_r1.liveAlertTotal, " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r1.selectedAlertSeverityFilter === "critical");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Critical ", ctx_r1.criticalAlertCount, " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r1.selectedAlertSeverityFilter === "warning");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Warning ", ctx_r1.warningAlertCount, " ");
    \u0275\u0275advance();
    \u0275\u0275classProp("active", ctx_r1.selectedAlertSeverityFilter === "info");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" Info ", ctx_r1.infoAlertCount, " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.filteredLiveAlerts.length > 0)("ngIfElse", noHeaderAlerts_r4);
  }
}
var HeaderComponent = class _HeaderComponent {
  constructor(navServices, _authService, _userService, router, liveAlertsService, elementRef, renderer) {
  ...
  static {
    this.\u0275fac = function HeaderComponent_Factory(t) {
      return new (t || _HeaderComponent)(\u0275\u0275directiveInject(NavService), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(LiveAlertsService), \u0275\u0275directiveInject(ElementRef), \u0275\u0275directiveInject(Renderer2));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], hostBindings: function HeaderComponent_HostBindings(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275element(15, "span");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(16, "div", 16)(17, "div", 17)(18, "a", 18);
        ...
        \u0275\u0275element(21, "i", 21);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(22, HeaderComponent_div_22_Template, 24, 20, "div", 22);
        \u0275\u0275elementStart(23, "div", 23)(24, "a", 24);
        \u0275\u0275listener("click", function HeaderComponent_Template_a_click_24_listener() {
          return ctx.toggleFullScreen();
        });
        \u0275\u0275element(25, "i", 25)(26, "i", 26);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(27, "div", 27)(28, "button", 28);
        \u0275\u0275element(29, "img", 29);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(30, "div", 30)(31, "p", 31);
        \u0275\u0275text(32);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(33, "span", 32);
        \u0275\u0275text(34);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(35, "div", 33)(36, "ul", 34)(37, "li")(38, "a", 35);
      ...
      if (rf & 2) {
        \u0275\u0275advance(22);
        \u0275\u0275property("ngIf", ctx.showLiveAlerts);
        \u0275\u0275advance(2);
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(7, _c0, !ctx.isFullScreen));
        \u0275\u0275advance();
    ...
    }, dependencies: [NgClass, NgForOf, NgIf, RouterLink, FullscreenDirective], styles: ["\n\n.header-live-alerts[_ngcontent-%COMP%] {\n  position: relative;\n  display: flex;\n  align-items: center;\n}\n.header-alert-toggle[_ngcontent-%COMP%] {\n  position: relative;\n  display: inline-flex;\n  width: 2.25rem;\n  height: 2.25rem;\n  align-items: center;\n  justify-content: center;\n  border: 0;\n  border-radius: 999px;\n  background: transparent;\n  color: rgb(var(--default-text-color));\n  transition: background 160ms ease, color 160ms ease;\n}\n.header-alert-toggle[_ngcontent-%COMP%]:hover, .header-alert-toggle.has-alerts[_ngcontent-%COMP%] {\n  background: rgba(var(--primary), 0.1);\n  color: rgb(var(--primary));\n}\n.header-alert-badge[_ngcontent-%COMP%] {\n  position: absolute;\n  min-width: 1rem;\n  height: 1rem;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  inset-inline-end: -0.25rem;\n  inset-block-start: -0.15rem;\n  border: 2px solid #fff;\n  border-radius: 999px;\n  background: rgb(var(--danger));\n  color: #fff;\n  font-size: 0.56rem;\n  font-weight: 800;\n  line-height: 1;\n  padding: 0 0.18rem;\n}\n.header-alert-panel[_ngcontent-%COMP%] {\n  position: absolute;\n  z-index: 60;\n  width: min(24rem, 100vw - 1.5rem);\n  inset-block-start: calc(100% + 0.45rem);\n  inset-inline-end: 0;\n  overflow: hidden;\n  border: 1px solid rgba(var(--default-border), 1);\n  border-radius: 0.85rem;\n  background: #fff;\n  box-shadow: 0 1rem 2.5rem rgba(15, 23, 42, 0.18);\n  opacity: 0;\n  pointer-events: none;\n  transform: translateY(-0.35rem);\n  transition: opacity 160ms ease, transform 160ms ease;\n}\n.header-alert-panel.open[_ngcontent-%COMP%] {\n  opacity: 1;\n  pointer-events: auto;\n  transform: translateY(0);\n}\n.header-alert-panel-header[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 1rem;\n  padding: 1rem 1rem 0.8rem;\n  border-bottom: 1px solid rgba(var(--default-border), 1);\n}\n.header-alert-panel-header[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%], .header-alert-panel-header[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n}\n.header-alert-panel-header[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  color: rgb(var(--default-text-color));\n  font-size: 0.95rem;\n  font-weight: 750;\n}\n.header-alert-panel-header[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin-top: 0.1rem;\n  color: rgb(var(--text-muted));\n  font-size: 0.7rem;\n}\n.header-alert-live-dot[_ngcontent-%COMP%] {\n  width: 0.55rem;\n  height: 0.55rem;\n  border-radius: 50%;\n  background: rgb(var(--success));\n  box-shadow: 0 0 0 0.35rem rgba(var(--success), 0.12);\n}\n.header-alert-filters[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 0.45rem;\n  overflow-x: auto;\n  padding: 0.75rem 0.85rem;\n  border-bottom: 1px solid rgba(var(--default-border), 1);\n  scrollbar-width: none;\n}\n.header-alert-filters[_ngcontent-%COMP%]::-webkit-scrollbar {\n  display: none;\n}\n.header-alert-filters[_ngcontent-%COMP%]   button[_ngcontent-%COMP%] {\n  flex: 0 0 auto;\n  border: 1px solid rgba(var(--default-border), 1);\n  border-radius: 999px;\n  background: rgba(var(--light), 1);\n  color: rgb(var(--text-muted));\n  padding: 0.32rem 0.62rem;\n  font-size: 0.66rem;\n  font-weight: 750;\n}\n.header-alert-filters[_ngcontent-%COMP%]   button.active[_ngcontent-%COMP%] {\n  border-color: rgba(var(--primary), 0.35);\n  background: rgba(var(--primary), 0.1);\n  color: rgb(var(--primary));\n}\n.header-alert-list[_ngcontent-%COMP%] {\n  max-height: 21rem;\n  overflow-y: auto;\n  padding: 0.55rem;\n  overscroll-behavior: contain;\n}\n.header-alert-list[_ngcontent-%COMP%]::-webkit-scrollbar {\n  width: 0.35rem;\n}\n.header-alert-list[_ngcontent-%COMP%]::-webkit-scrollbar-thumb {\n  border-radius: 999px;\n  background: rgba(var(--gray-400), 0.8);\n}\n.header-alert-item[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: auto minmax(0, 1fr);\n  gap: 0.65rem;\n  padding: 0.72rem;\n  border-radius: 0.75rem;\n  background: rgba(var(--light), 1);\n}\n.header-alert-item[_ngcontent-%COMP%]    + .header-alert-item[_ngcontent-%COMP%] {\n  margin-top: 0.45rem;\n}\n.header-alert-icon[_ngcontent-%COMP%] {\n  display: inline-flex;\n  width: 2rem;\n  height: 2rem;\n  align-items: center;\n  justify-content: center;\n  border-radius: 0.55rem;\n  background: rgba(var(--primary), 0.1);\n  color: rgb(var(--primary));\n}\n.header-alert-critical[_ngcontent-%COMP%]   .header-alert-icon[_ngcontent-%COMP%] {\n  background: rgba(var(--danger), 0.12);\n  color: rgb(var(--danger));\n}\n.header-alert-warning[_ngcontent-%COMP%]   .header-alert-icon[_ngcontent-%COMP%] {\n  background: rgba(var(--warning), 0.15);\n  color: rgb(var(--warning));\n}\n.header-alert-info[_ngcontent-%COMP%]   .header-alert-icon[_ngcontent-%COMP%] {\n  background: rgba(var(--info), 0.12);\n  color: rgb(var(--info));\n}\n.header-alert-title-row[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  gap: 0.6rem;\n  min-width: 0;\n}\n.header-alert-title-row[_ngcontent-%COMP%]   strong[_ngcontent-%COMP%] {\n  overflow: hidden;\n  color: rgb(var(--default-text-color));\n  font-size: 0.76rem;\n  font-weight: 750;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.header-alert-title-row[_ngcontent-%COMP%]   small[_ngcontent-%COMP%] {\n  flex: none;\n  color: rgb(var(--text-muted));\n  font-size: 0.62rem;\n}\n.header-alert-item[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  display: -webkit-box;\n  overflow: hidden;\n  margin: 0.2rem 0 0;\n  color: rgb(var(--text-muted));\n  font-size: 0.68rem;\n  line-height: 1.35;\n  -webkit-box-orient: vertical;\n  -webkit-line-clamp: 2;\n}\n.header-alert-item[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]:not(.header-alert-icon) {\n  display: block;\n  overflow: hidden;\n  margin-top: 0.28rem;\n  color: rgb(var(--primary));\n  font-size: 0.64rem;\n  font-weight: 700;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n}\n.header-alert-empty[_ngcontent-%COMP%] {\n  display: grid;\n  place-items: center;\n  gap: 0.45rem;\n  min-height: 10rem;\n  color: rgb(var(--text-muted));\n  text-align: center;\n}\n.header-alert-empty[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  color: rgb(var(--success));\n  font-size: 1.8rem;\n}\n.dark[_nghost-%COMP%]   .header-alert-panel[_ngcontent-%COMP%], .dark   [_nghost-%COMP%]   .header-alert-panel[_ngcontent-%COMP%] {\n  background: rgb(var(--body-bg));\n  box-shadow: 0 1rem 2.5rem rgba(0, 0, 0, 0.32);\n}\n.dark[_nghost-%COMP%]   .header-alert-badge[_ngcontent-%COMP%], .dark   [_nghost-%COMP%]   .header-alert-badge[_ngcontent-%COMP%] {\n  border-color: rgb(var(--body-bg));\n}\n@media (max-width: 575.98px) {\n  .header-alert-panel[_ngcontent-%COMP%] {\n    position: fixed;\n    inset-block-start: 4rem;\n    inset-inline: 0.75rem;\n    width: auto;\n  }\n}\n/*# sourceMappingURL=header.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeaderComponent, { className: "HeaderComponent", filePath: "src\\app\\shared\\components\\header\\header.component.ts", lineNumber: 23 });
})();
...
//# sourceMappingURL=chunk-WXP2OXZD.js.map
