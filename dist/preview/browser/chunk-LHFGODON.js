...
function HeaderComponent_div_43_article_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "article", 49)(1, "span", 50);
    \u0275\u0275element(2, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div")(4, "div", 51)(5, "strong");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
...
function HeaderComponent_div_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, HeaderComponent_div_43_article_1_Template, 13, 7, "article", 48);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function HeaderComponent_ng_template_44_Template(rf, ctx) {
  if (rf & 1) {
    ...
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], hostBindings: function HeaderComponent_HostBindings(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275listener("click", function HeaderComponent_Template_a_click_18_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.themeChange("dark", "dark", "dark"));
        });
        \u0275\u0275element(19, "i", 19);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("click", function HeaderComponent_Template_a_click_20_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.themeChange("light", "light", "dark"));
        });
        \u0275\u0275element(21, "i", 21);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(22, "div", 22)(23, "button", 23);
        \u0275\u0275listener("click", function HeaderComponent_Template_button_click_23_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.toggleAlertPanel($event));
        });
        \u0275\u0275element(24, "i", 24);
        \u0275\u0275template(25, HeaderComponent_span_25_Template, 2, 1, "span", 25);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(26, "div", 26);
        \u0275\u0275listener("click", function HeaderComponent_Template_div_click_26_listener($event) {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.handleAlertPanelClick($event));
        });
        \u0275\u0275elementStart(27, "div", 27)(28, "div")(29, "h3");
        \u0275\u0275text(30, "Operations alerts");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(31, "p");
        \u0275\u0275text(32);
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275listener("click", function HeaderComponent_Template_button_click_35_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setAlertFilter("all"));
        });
        \u0275\u0275text(36);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("click", function HeaderComponent_Template_button_click_37_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setAlertFilter("critical"));
        });
        \u0275\u0275text(38);
        \u0275\u0275elementEnd();
        ...
        \u0275\u0275listener("click", function HeaderComponent_Template_button_click_39_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setAlertFilter("warning"));
        });
        \u0275\u0275text(40);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(41, "button", 30);
        \u0275\u0275listener("click", function HeaderComponent_Template_button_click_41_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.setAlertFilter("info"));
        });
        \u0275\u0275text(42);
        \u0275\u0275elementEnd()();
        \u0275\u0275template(43, HeaderComponent_div_43_Template, 2, 2, "div", 31)(44, HeaderComponent_ng_template_44_Template, 4, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(46, "div", 32)(47, "a", 33);
        \u0275\u0275listener("click", function HeaderComponent_Template_a_click_47_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.toggleFullScreen());
        });
        \u0275\u0275element(48, "i", 34)(49, "i", 35);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(50, "div", 36)(51, "button", 37);
        \u0275\u0275element(52, "img", 38);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(53, "div", 39)(54, "p", 40);
        \u0275\u0275text(55);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(56, "span", 41);
        \u0275\u0275text(57);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(58, "div", 42)(59, "ul", 43)(60, "li")(61, "a", 44);
        \u0275\u0275listener("click", function HeaderComponent_Template_a_click_61_listener() {
          \u0275\u0275restoreView(_r1);
          return \u0275\u0275resetView(ctx.singOut());
        });
        \u0275\u0275element(62, "i", 45);
        \u0275\u0275text(63, "Log Out");
        \u0275\u0275elementEnd()()()()()()()()();
      ...
      if (rf & 2) {
        const noHeaderAlerts_r4 = \u0275\u0275reference(45);
        \u0275\u0275advance(23);
        \u0275\u0275classProp("has-alerts", ctx.unreadAlertCount > 0);
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.unreadAlertCount > 0);
        \u0275\u0275advance();
        \u0275\u0275classProp("open", ctx.isAlertPanelOpen);
        \u0275\u0275advance(6);
        \u0275\u0275textInterpolate1("", ctx.liveAlertTotal, " active");
        \u0275\u0275advance(3);
        \u0275\u0275classProp("active", ctx.selectedAlertSeverityFilter === "all");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" All ", ctx.liveAlertTotal, " ");
        \u0275\u0275advance();
        \u0275\u0275classProp("active", ctx.selectedAlertSeverityFilter === "critical");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" Critical ", ctx.criticalAlertCount, " ");
        \u0275\u0275advance();
        \u0275\u0275classProp("active", ctx.selectedAlertSeverityFilter === "warning");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" Warning ", ctx.warningAlertCount, " ");
        \u0275\u0275advance();
        \u0275\u0275classProp("active", ctx.selectedAlertSeverityFilter === "info");
        \u0275\u0275advance();
        \u0275\u0275textInterpolate1(" Info ", ctx.infoAlertCount, " ");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.filteredLiveAlerts.length > 0)("ngIfElse", noHeaderAlerts_r4);
        \u0275\u0275advance(4);
        \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(26, _c0, !ctx.isFullScreen));
        \u0275\u0275advance();
...
//# sourceMappingURL=chunk-LHFGODON.js.map
