    ...
    children: [
      {
        path: "",
        pathMatch: "full",
        loadComponent: () => import("./chunk-PBFA2NS3.js").then((m) => m.CrmComponent)
      },
      {
        path: "crm",
        pathMatch: "full",
      ...
      {
        path: "crm/deep-dive",
        loadComponent: () => import("./chunk-AY4T3P7G.js").then((m) => m.EnergyDeepDiveComponent)
      },
      {
...
//# sourceMappingURL=chunk-DYJD6BYK.js.map
