...
!function(e, t) {
  ...
  return (() => {
    ...
    var e = { 661: (e2, t2, o2) => {
      ...
      var E = "top", k = "bottom", j2 = "right", P = "left", L = "auto", A = [E, k, j2, P], T = "start", C = "end", q = "viewport", R = "popper", D = A.reduce(function(e3, t3) {
      ...
      function X(e3) {
        ...
        if (f2) {
          ...
          T2 === n2(o3) && "static" !== h(T2 = d(o3)).position && "absolute" === c2 && (q2 = "scrollHeight", R2 = "scrollWidth"), T2 = T2, (i2 === E || (i2 === P || i2 === j2) && a2 === C) && (L2 = k, g2 -= (y2 && A2.visualViewport ? A2.visualViewport.height : T2[q2]) - r2.height, g2 *= u2 ? 1 : -1), i2 !== P && (i2 !== E && i2 !== k || a2 !== C) || (x2 = j2, m2 -= (y2 && A2.visualViewport ? A2.visualViewport.width : T2[R2]) - r2.width, m2 *= u2 ? 1 : -1);
        }
      ...
      function re(e3, t3) {
        ...
        if (b2 === R && $2) {
          ...
          Object.keys(W2).forEach(function(e4) {
            var t4 = [j2, k].indexOf(e4) >= 0 ? 1 : -1, o4 = [E, k].indexOf(e4) >= 0 ? "y" : "x";
            W2[e4] += N2[o4] * t4;
          });
        }
        return W2;
      ...
      function se(e3) {
        return [E, j2, k, P].some(function(t3) {
          return e3[t3] >= 0;
        });
      }
      var ce = W({ defaultModifiers: [{ name: "eventListeners", enabled: true, phase: "write", fn: function() {
        ...
        var t3 = e3.state, o3 = e3.options, n3 = e3.name, r2 = o3.offset, i2 = void 0 === r2 ? [0, 0] : r2, a2 = H.reduce(function(e4, o4) {
          return e4[o4] = function(e5, t4, o5) {
            ...
            return a3 = a3 || 0, s3 = (s3 || 0) * r3, [P, j2].indexOf(n4) >= 0 ? { x: s3, y: a3 } : { x: a3, y: s3 };
          }(o4, t3.rects, i2), e4;
        ...
        if (!t3.modifiersData[n3]._skip) {
          for (var r2 = o3.mainAxis, i2 = void 0 === r2 || r2, a2 = o3.altAxis, s2 = void 0 === a2 || a2, c2 = o3.fallbackPlacements, l2 = o3.padding, u2 = o3.boundary, f2 = o3.rootBoundary, p2 = o3.altBoundary, d2 = o3.flipVariations, y2 = void 0 === d2 || d2, h2 = o3.allowedAutoPlacements, v2 = t3.options.placement, m2 = N(v2), b2 = c2 || (m2 !== v2 && y2 ? function(e4) {
            ...
            var q2 = g2[C2], R2 = N(q2), B2 = Z(q2) === T, I2 = [E, k].indexOf(R2) >= 0, M2 = I2 ? "width" : "height", V2 = re(t3, { placement: q2, boundary: u2, rootBoundary: f2, altBoundary: p2, padding: l2 }), W2 = I2 ? B2 ? j2 : P : B2 ? k : E;
            w2[M2] > O2[M2] && (W2 = G(W2));
            var $2 = G(W2), U2 = [];
        ...
        if (A2) {
          if (i2) {
            var I2, M2 = "y" === x2 ? E : P, V2 = "y" === x2 ? k : j2, W2 = "y" === x2 ? "height" : "width", $2 = A2[x2], z2 = $2 + g2[M2], F2 = $2 - g2[V2], X2 = h2 ? -q2[W2] / 2 : 0, Y2 = O2 === T ? C2[W2] : q2[W2], G2 = O2 === T ? -q2[W2] : -C2[W2], J2 = t3.elements.arrow, K2 = h2 && J2 ? b(J2) : { width: 0, height: 0 }, Q2 = t3.modifiersData["arrow#persistent"] ? t3.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 }, ee2 = Q2[M2], te2 = Q2[V2], oe2 = ie(0, C2[W2], K2[W2]), ne2 = S2 ? C2[W2] / 2 - X2 - oe2 - ee2 - D2.mainAxis : Y2 - oe2 - ee2 - D2.mainAxis, ae2 = S2 ? -C2[W2] / 2 + X2 + oe2 + te2 + D2.mainAxis : G2 + oe2 + te2 + D2.mainAxis, se2 = t3.elements.arrow && _(t3.elements.arrow), ce2 = se2 ? "y" === x2 ? se2.clientTop || 0 : se2.clientLeft || 0 : 0, le = null != (I2 = null == H2 ? void 0 : H2[x2]) ? I2 : 0, ue = $2 + ae2 - le, fe = ie(h2 ? c(z2, $2 + ne2 - le - ce2) : z2, $2, h2 ? s(F2, ue) : F2);
            A2[x2] = fe, B2[x2] = fe - $2;
          }
          if (l2) {
            var pe, de = "x" === x2 ? E : P, ye = "x" === x2 ? k : j2, he = A2[L2], ve = "y" === L2 ? "height" : "width", me = he + g2[de], be = he - g2[ye], ge = -1 !== [E, P].indexOf(w2), we = null != (pe = null == H2 ? void 0 : H2[L2]) ? pe : 0, Oe = ge ? me : he - C2[ve] - q2[ve] - we + D2.altAxis, Se = ge ? he + C2[ve] + q2[ve] - we - D2.altAxis : be, xe = h2 && ge ? function(e4, t4, o4) {
              var n4 = ie(e4, t4, o4);
              return n4 > o4 ? o4 : n4;
        ...
        var t3, o3 = e3.state, n3 = e3.name, r2 = e3.options, i2 = o3.elements.arrow, a2 = o3.modifiersData.popperOffsets, s2 = N(o3.placement), c2 = U(s2), l2 = [P, j2].indexOf(s2) >= 0 ? "height" : "width";
        if (i2 && a2) {
          ...
          }(r2.padding, o3), f2 = b(i2), p2 = "y" === c2 ? E : P, d2 = "y" === c2 ? k : j2, y2 = o3.rects.reference[l2] + o3.rects.reference[c2] - a2[c2] - o3.rects.popper[l2], h2 = a2[c2] - o3.rects.reference[c2], v2 = _(i2), m2 = v2 ? "y" === c2 ? v2.clientHeight || 0 : v2.clientWidth || 0 : 0, g2 = y2 / 2 - h2 / 2, w2 = u2[p2], O2 = m2 - f2[l2] - u2[d2], S2 = m2 / 2 - f2[l2] / 2 + g2, x2 = ie(w2, S2, O2), L2 = c2;
