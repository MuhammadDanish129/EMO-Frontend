...
var EnergyDashboardService = class _EnergyDashboardService {
  ...
  getMonthlyDeviceTypeReport() {
    return this.http.get(`${this.baseUrl}/GetMonthlyDeviceTypeReport`);
  }
  getEnergyConsumptionByDeviceTypeLast12Months() {
    return this.http.get(`${this.baseUrl}/GetEnergyConsumptionByDeviceTypeLast12Months`);
  }
  getPeakNonPeakAnalysis(startDate, endDate) {
    const params = new HttpParams().set("startDate", startDate).set("endDate", endDate);
    return this.http.get(`${this.baseUrl}/GetPeakNonPeakAnalysis`, { params });
  }
  exportPeakNonPeakAnalysisCsv(startDate, endDate) {
    const params = new HttpParams().set("startDate", startDate).set("endDate", endDate);
  ...
  exportEnergyConsumptionByDeviceTypeCsv() {
...
var _c02 = ["chart"];
function CrmComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(5, "i", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "span", 17)(7, "span", 18)(8, "span", 19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "div", 20)(10, "p", 21);
    \u0275\u0275text(11, " Preparing energy dashboard ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "p", 22);
    \u0275\u0275text(13, " Fetching live consumption, reports, and peak analysis. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "div", 23);
    \u0275\u0275element(15, "span");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(16, "div", 24)(17, "div", 25);
    \u0275\u0275element(18, "span")(19, "span")(20, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 26);
    \u0275\u0275element(22, "span")(23, "span")(24, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "div", 26);
    \u0275\u0275element(26, "span")(27, "span")(28, "span");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "div", 27);
    \u0275\u0275element(30, "span")(31, "span")(32, "span")(33, "span");
    \u0275\u0275elementEnd()()();
  }
}
function CrmComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 28)(1, "span");
    \u0275\u0275text(2, "Updating dashboard data...");
    \u0275\u0275elementEnd();
...
function CrmComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
...
function CrmComponent_div_12_apx_chart_158_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "apx-chart", 115);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("series", ctx_r0.peakNonPeakChartOptions.series)("chart", ctx_r0.peakNonPeakChartOptions.chart)("xaxis", ctx_r0.peakNonPeakChartOptions.xaxis)("yaxis", ctx_r0.peakNonPeakChartOptions.yaxis)("stroke", ctx_r0.peakNonPeakChartOptions.stroke)("dataLabels", ctx_r0.peakNonPeakChartOptions.dataLabels)("colors", ctx_r0.peakNonPeakChartOptions.colors)("grid", ctx_r0.peakNonPeakChartOptions.grid)("legend", ctx_r0.peakNonPeakChartOptions.legend)("markers", ctx_r0.peakNonPeakChartOptions.markers)("tooltip", ctx_r0.peakNonPeakChartOptions.tooltip);
  }
}
function CrmComponent_div_12_apx_chart_169_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "apx-chart", 116, 0);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("series", ctx_r0.deviceTypeChartOptions.series)("chart", ctx_r0.deviceTypeChartOptions.chart)("dataLabels", ctx_r0.deviceTypeChartOptions.dataLabels)("plotOptions", ctx_r0.deviceTypeChartOptions.plotOptions)("yaxis", ctx_r0.deviceTypeChartOptions.yaxis)("xaxis", ctx_r0.deviceTypeChartOptions.xaxis)("legend", ctx_r0.deviceTypeChartOptions.legend)("colors", ctx_r0.deviceTypeChartOptions.colors)("grid", ctx_r0.deviceTypeChartOptions.grid)("fill", ctx_r0.deviceTypeChartOptions.fill)("tooltip", ctx_r0.deviceTypeChartOptions.tooltip);
  }
}
function CrmComponent_div_12_apx_chart_179_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "apx-chart", 117);
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
    \u0275\u0275property("series", ctx_r0.monthlyReportChartOptions.series)("chart", ctx_r0.monthlyReportChartOptions.chart)("colors", ctx_r0.monthlyReportChartOptions.colors)("labels", ctx_r0.monthlyReportChartOptions.labels)("legend", ctx_r0.monthlyReportChartOptions.legend)("stroke", ctx_r0.monthlyReportChartOptions.stroke)("tooltip", ctx_r0.monthlyReportChartOptions.tooltip)("plotOptions", ctx_r0.monthlyReportChartOptions.plotOptions)("dataLabels", ctx_r0.monthlyReportChartOptions.dataLabels);
  }
}
function CrmComponent_div_12_div_181_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 118)(1, "div", 119)(2, "span", 120);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "div")(5, "span", 121);
    \u0275\u0275text(6);
    \u0275\u0275pipe(7, "number");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", item_r3.utilityName, " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(7, 3, item_r3.percentage, "1.0-2"), "% ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(10, 6, item_r3.totalKwh, "1.2-2"), " kWh ");
  }
}
function CrmComponent_div_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 32)(1, "div", 33)(2, "div", 32)(3, "div", 34)(4, "div", 35)(5, "div", 36)(6, "div", 37);
    \u0275\u0275text(7, " Idle Devices ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "div", 38)(9, "ul", 39)(10, "li", 40)(11, "div", 41)(12, "div", 42)(13, "span", 43);
    \u0275\u0275element(14, "i", 44);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 45)(16, "p", 46);
    \u0275\u0275text(17, " Honeywell T7350 Thermostat ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "p", 47);
    \u0275\u0275text(19, " HVAC Controller ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "div")(21, "span", 48);
    \u0275\u0275text(22, " Idle ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(23, "li", 40)(24, "div", 41)(25, "div", 42)(26, "span", 49);
    \u0275\u0275element(27, "i", 50);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "div", 45)(29, "p", 46);
    \u0275\u0275text(30, " APC Smart-UPS 5000VA ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(31, "p", 47);
    \u0275\u0275text(32, " Backup UPS ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "div")(34, "span", 48);
    \u0275\u0275text(35, " Idle ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(36, "li", 40)(37, "div", 41)(38, "div", 42)(39, "span", 51);
    \u0275\u0275element(40, "i", 52);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(41, "div", 45)(42, "p", 46);
    \u0275\u0275text(43, " HP Z4 Workstation ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(44, "p", 47);
    \u0275\u0275text(45, " Computation Unit ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div")(47, "span", 48);
    \u0275\u0275text(48, " Idle ");
    \u0275\u0275elementEnd()()()()()()();
    \u0275\u0275elementStart(49, "div", 35)(50, "div", 53)(51, "div", 37);
    \u0275\u0275text(52, " Active Device Alerts ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(53, "div", 54)(54, "a", 55);
    \u0275\u0275text(55, " Actions");
    \u0275\u0275element(56, "i", 56);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(57, "ul", 57)(58, "li")(59, "a", 58);
    \u0275\u0275text(60, " Acknowledge All ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(61, "li")(62, "a", 58);
    \u0275\u0275text(63, " View Full Log ");
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(64, "div", 38)(65, "div", 59)(66, "h4", 60);
    \u0275\u0275text(67, "13");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(68, "div", 61)(69, "span", 62);
    \u0275\u0275text(70, " 3");
    \u0275\u0275element(71, "i", 63);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(72, "span", 64);
    \u0275\u0275text(73, " new alerts in the last hour ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(74, "div", 65);
    \u0275\u0275element(75, "div", 66)(76, "div", 67)(77, "div", 68);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(78, "ul", 69)(79, "li")(80, "div", 70)(81, "div", 71);
    \u0275\u0275element(82, "i", 72);
    \u0275\u0275text(83, " Critical ");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(85, "2 Alerts");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(86, "li")(87, "div", 74)(88, "div", 75);
    \u0275\u0275element(89, "i", 76);
    \u0275\u0275text(90, " Warning ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "div", 77);
    \u0275\u0275text(92, "4 Alerts");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(93, "li")(94, "div", 78)(95, "div", 79);
    \u0275\u0275element(96, "i", 80);
    \u0275\u0275text(97, " Informational ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(98, "div", 81);
    \u0275\u0275text(99, "7 Alerts");
    \u0275\u0275elementEnd()()()()()()();
    \u0275\u0275elementStart(100, "div", 82)(101, "div", 32)(102, "div", 83)(103, "div", 35)(104, "div", 84)(105, "div")(106, "div", 37);
    \u0275\u0275text(107, " Peak vs Non-Peak Analysis ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(108, "p", 85);
    \u0275\u0275text(109, " Default range is last 30 days. ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(110, "button", 86);
    \u0275\u0275listener("click", function CrmComponent_div_12_Template_button_click_110_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.exportPeakNonPeakCsv());
    });
    \u0275\u0275element(111, "i", 87);
    \u0275\u0275text(112, " CSV ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(113, "div", 38)(114, "div", 88)(115, "div", 89)(116, "label", 90);
    \u0275\u0275text(117, " Start Date ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(118, "input", 91);
    \u0275\u0275twoWayListener("ngModelChange", function CrmComponent_div_12_Template_input_ngModelChange_118_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(119, "div", 89)(120, "label", 90);
    \u0275\u0275text(121, " End Date ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(122, "input", 91);
    \u0275\u0275twoWayListener("ngModelChange", function CrmComponent_div_12_Template_input_ngModelChange_122_listener($event) {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r0.endDate, $event) || (ctx_r0.endDate = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(123, "div", 92)(124, "button", 93);
    \u0275\u0275listener("click", function CrmComponent_div_12_Template_button_click_124_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.applyPeakNonPeakFilter());
    });
    \u0275\u0275text(125, " Apply Filter ");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(126, "div", 88)(127, "div", 89)(128, "div", 94)(129, "p", 95);
    \u0275\u0275text(130, "Peak Usage");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(131, "h5", 96);
    \u0275\u0275text(132);
    \u0275\u0275pipe(133, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(134, "span", 97);
    \u0275\u0275text(135);
    \u0275\u0275pipe(136, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(137, "div", 89)(138, "div", 98)(139, "p", 95);
    \u0275\u0275text(140, "Non-Peak Usage");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(141, "h5", 99);
    \u0275\u0275text(142);
    \u0275\u0275pipe(143, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(144, "span", 97);
    \u0275\u0275text(145);
    \u0275\u0275pipe(146, "number");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(147, "div", 89)(148, "div", 100)(149, "p", 95);
    \u0275\u0275text(150, "Total Usage");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(151, "h5", 101);
    \u0275\u0275text(152);
    \u0275\u0275pipe(153, "number");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(154, "span", 97);
    \u0275\u0275text(155, " Selected range ");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(156, "div", 102)(157, "div", 103);
    \u0275\u0275template(158, CrmComponent_div_12_apx_chart_158_Template, 1, 11, "apx-chart", 104);
    \u0275\u0275elementEnd()()()()();
    \u0275\u0275elementStart(159, "div", 83)(160, "div", 35)(161, "div", 84)(162, "div", 37);
    \u0275\u0275text(163, " Energy Consumption by Device Type (Last 12 Months) ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(164, "button", 86);
    \u0275\u0275listener("click", function CrmComponent_div_12_Template_button_click_164_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.exportEnergyConsumptionCsv());
    });
    \u0275\u0275element(165, "i", 87);
    \u0275\u0275text(166, " CSV ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(167, "div", 38)(168, "div", 105);
    \u0275\u0275template(169, CrmComponent_div_12_apx_chart_169_Template, 2, 11, "apx-chart", 106);
    \u0275\u0275elementEnd()()()()()()()();
    \u0275\u0275elementStart(170, "div", 107)(171, "div", 108)(172, "div", 109)(173, "div", 35)(174, "div", 53)(175, "div", 37);
    \u0275\u0275text(176, " Monthly Device Type Report ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(177, "div", 110)(178, "div", 111);
    \u0275\u0275template(179, CrmComponent_div_12_apx_chart_179_Template, 1, 9, "apx-chart", 112);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(180, "div", 113);
    \u0275\u0275template(181, CrmComponent_div_12_div_181_Template, 11, 9, "div", 114);
    \u0275\u0275elementEnd()()()()()();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(4);
    \u0275\u0275twoWayProperty("ngModel", ctx_r0.endDate);
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(133, 11, ctx_r0.peakNonPeak == null ? null : ctx_r0.peakNonPeak.totalPeakKwh, "1.2-2"), " kWh ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(136, 14, ctx_r0.peakNonPeak == null ? null : ctx_r0.peakNonPeak.peakPercentage, "1.2-2"), "% ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(143, 17, ctx_r0.peakNonPeak == null ? null : ctx_r0.peakNonPeak.totalNonPeakKwh, "1.2-2"), " kWh ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(146, 20, ctx_r0.peakNonPeak == null ? null : ctx_r0.peakNonPeak.nonPeakPercentage, "1.2-2"), "% ");
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(153, 23, ctx_r0.peakNonPeak == null ? null : ctx_r0.peakNonPeak.totalKwh, "1.2-2"), " kWh ");
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", ctx_r0.peakNonPeakChartOptions);
    \u0275\u0275advance(11);
    \u0275\u0275property("ngIf", ctx_r0.deviceTypeChartOptions);
    \u0275\u0275advance(10);
    \u0275\u0275property("ngIf", ctx_r0.monthlyReportChartOptions);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r0.monthlyDeviceTypeReport);
  }
}
var CrmComponent = class _CrmComponent {
  constructor(userService, energyDashboardService) {
    ...
    this.peakNonPeak = null;
    this.monthlyReportTotalPercentage = 0;
    this.startDate = "";
    this.endDate = "";
    this.peakNonPeakMaxVisibleXAxisLabels = 10;
  }
  ngOnInit() {
  ...
  loadDashboardData() {
    ...
    forkJoin({
      ...
      next: (res) => {
        if (!res.monthlyDeviceTypeReport.success || !res.consumptionByDeviceType.success || !res.peakNonPeak.success) {
  ...
  prepareEnergyConsumptionChart() {
    ...
    const utilities = Array.from(new Set(this.consumptionByDeviceType.map((x) => x.utilityName)));
    const series = utilities.map((utility) => {
      return {
        name: utility,
        data: monthOrder.map((monthLabel) => {
          const item = this.consumptionByDeviceType.find((x) => `${x.month} ${x.year}` === monthLabel && x.utilityName === utility);
  ...
  preparePeakNonPeakChart() {
    ...
    this.peakNonPeakChartOptions = {
      ...
      tooltip: {
        ...
        intersect: false,
        x: {
          formatter: (value) => this.formatChartDate(value, true)
        },
        y: {
          formatter: (value) => `${value.toFixed(2)} kWh`
        }
  ...
  exportPeakNonPeakCsv() {
    this.energyDashboardService.exportPeakNonPeakAnalysisCsv(this.startDate, this.endDate).subscribe((blob) => {
      this.downloadFile(blob, "peak-non-peak-analysis.csv");
    });
  }
  exportEnergyConsumptionCsv() {
    this.energyDashboardService.exportEnergyConsumptionByDeviceTypeCsv().subscribe((blob) => {
  ...
  getPeriodTimestamp(period, index) {
    const parsedDate = /^\d{4}-\d{2}-\d{2}/.test(period) ? /* @__PURE__ */ new Date(`${period.slice(0, 10)}T00:00:00`) : new Date(period);
  ...
  formatChartDate(value, includeYear) {
    const date = new Date(value);
    if (Number.isNaN(date.getTime())) {
      return "";
    }
    return date.toLocaleDateString("en-US", __spreadValues({
      month: "short",
      day: "2-digit"
  ...
  static {
    this.\u0275fac = function CrmComponent_Factory(t) {
      return new (t || _CrmComponent)(\u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(EnergyDashboardService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CrmComponent, selectors: [["app-crm"]], viewQuery: function CrmComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c02, 5);
      }
      if (rf & 2) {
    ...
    }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 13, vars: 5, consts: [["chart", ""], [1, "m-4", "pb-6", "sm:m-6", "lg:m-10"], [1, "md:flex", "block", "items-center", "justify-between", "my-[1.5rem]", "page-header-breadcrumb"], [1, "font-semibold", "text-[1.125rem]", "text-defaulttextcolor", "dark:text-defaulttextcolor/70", "!mb-0"], [1, "btn-list", "md:mt-0", "mt-2"], ["type", "button", 1, "ti-btn", "ti-btn-outline-secondary", "btn-wave", "!font-medium", "!me-[0.375rem]", "!ms-0", "!text-[0.85rem]", "!rounded-[0.35rem]", "!py-[0.51rem]", "!px-[0.86rem]", "shadow-none", 3, "click"], [1, "ri-upload-cloud-line", "inline-block"], ["class", "dashboard-loader", "role", "status", "aria-live", "polite", 4, "ngIf"], ["class", "dashboard-refresh-loader", "role", "status", "aria-live", "polite", 4, "ngIf"], ["class", "box", 4, "ngIf"], ["class", "grid grid-cols-12 gap-6 items-start", 4, "ngIf"], ["role", "status", "aria-live", "polite", 1, "dashboard-loader"], [1, "dashboard-loader-panel"], ["aria-hidden", "true", 1, "energy-loader"], [1, "energy-loader-ring"], [1, "energy-loader-core"], [1, "ri-flashlight-line"], [1, "energy-loader-bar", "energy-loader-bar-one"], [1, "energy-loader-bar", "energy-loader-bar-two"], [1, "energy-loader-bar", "energy-loader-bar-three"], [1, "dashboard-loader-copy"], [1, "font-semibold", "text-[1rem]", "text-defaulttextcolor", "dark:text-white", "mb-1"], [1, "text-[0.78rem]", "text-[#8c9097]", "dark:text-white/50", "mb-3"], [1, "dashboard-loader-progress"], [1, "dashboard-loader-grid"], [1, "dashboard-loader-card", "dashboard-loader-card-wide"], [1, "dashboard-loader-card"], [1, "dashboard-loader-card", "dashboard-loader-card-chart"], ["role", "status", "aria-live", "polite", 1, "dashboard-refresh-loader"], [1, "box"], [1, "box-body", "text-center", "py-10"], [1, "text-danger", "font-semibold"], [1, "grid", "grid-cols-12", "gap-6", "items-start"], [1, "xxl:col-span-9", "xl:col-span-12", "col-span-12"], [1, "xxl:col-span-4", "xl:col-span-4", "col-span-12", "space-y-6"], [1, "box", "overflow-hidden", "border", "border-defaultborder/70", "dark:border-defaultborder/10"], [1, "box-header", "flex", "justify-between"], [1, "box-title"], [1, "box-body"], [1, "list-none", "crm-top-deals", "mb-0"], [1, "mb-[0.9rem]"], [1, "flex", "items-start", "flex-wrap"], [1, "me-2"], [1, "inline-flex", "items-center", "justify-center", "!w-[1.75rem]", "!h-[1.75rem]", "rounded-full", "bg-sky-500/10", "text-sky-500"], [1, "ri-remote-control-2-line", "text-[0.9rem]"], [1, "flex-grow"], [1, "font-semibold", "mb-[1.4px]", "text-[0.813rem]"], [1, "text-[#8c9097]", "dark:text-white/50", "text-[0.75rem]"], [1, "ti-btn", "ti-btn-outline-success", "text-white", "!py-1", "!px-2", "!text-[0.75rem]", "!m-0", "!gap-0", "!font-medium"], [1, "inline-flex", "items-center", "justify-center", "!w-[1.75rem]", "!h-[1.75rem]", "rounded-full", "bg-rose-500/10", "text-rose-500"], [1, "ri-battery-charge-line", "text-[0.9rem]"], [1, "inline-flex", "items-center", "justify-center", "!w-[1.75rem]", "!h-[1.75rem]", "rounded-full", "bg-slate-500/10", "text-slate-500"], [1, "ri-computer-line", "text-[0.9rem]"], [1, "box-header", "justify-between"], [1, "hs-dropdown", "ti-dropdown"], ["href", "javascript:void(0);", 1, "text-[0.75rem]", "px-2", "font-normal", "text-[#8c9097]", "dark:text-white/50"], [1, "ri-arrow-down-s-line", "align-middle", "ms-1", "inline-block"], [1, "hs-dropdown-menu", "ti-dropdown-menu", "hidden"], ["href", "javascript:void(0);", 1, "ti-dropdown-item", "!py-2", "!px-[0.9375rem]", "!text-[0.8125rem]", "!font-medium", "block"], [1, "flex", "items-center", "mb-[0.8rem]"], [1, "font-bold", "mb-0", "text-[1.5rem]", "text-danger"], [1, "ms-2"], [1, "py-[0.18rem]", "px-[0.45rem]", "rounded-sm", "text-danger", "!font-medium", "!text-[0.75em]", "bg-danger/10"], [1, "ri-arrow-up-s-fill", "align-mmiddle", "ms-1"], [1, "text-[#8c9097]", "dark:text-white/50", "text-[0.813rem]", "ms-1"], [1, "flex", "w-full", "h-[0.3125rem]", "mb-6", "rounded-full", "overflow-hidden"], [1, "flex", "flex-col", "justify-center", "rounded-s-[0.625rem]", "overflow-hidden", "bg-danger", "w-[15%]"], [1, "flex", "flex-col", "justify-center", "rounded-none", "overflow-hidden", "bg-warning", "w-[30%]"], [1, "flex", "flex-col", "justify-center", "rounded-e-[0.625rem]", "overflow-hidden", "bg-info", "w-[55%]"], [1, "list-none", "mb-0", "pt-2", "crm-deals-status", "space-y-3"], [1, "flex", "items-center", "text-[0.875rem]", "justify-between", "p-2", "rounded-md", "bg-danger/5"], [1, "flex", "items-center", "font-semibold", "text-danger"], [1, "ri-error-warning-line", "me-2"], [1, "text-[0.875rem]", "text-danger", "font-bold"], [1, "flex", "items-center", "text-[0.875rem]", "justify-between", "p-2", "rounded-md", "bg-warning/5"], [1, "flex", "items-center", "font-semibold", "text-warning"], [1, "ri-alert-line", "me-2"], [1, "text-[0.875rem]", "text-warning", "font-bold"], [1, "flex", "items-center", "text-[0.875rem]", "justify-between", "p-2", "rounded-md", "bg-info/5"], [1, "flex", "items-center", "font-semibold", "text-info"], [1, "ri-information-line", "me-2"], [1, "text-[0.875rem]", "text-info", "font-bold"], [1, "xxl:col-span-8", "xl:col-span-8", "col-span-12"], [1, "xxl:col-span-12", "xl:col-span-12", "col-span-12"], [1, "box-header", "justify-between", "gap-3", "flex-wrap"], [1, "text-[#8c9097]", "dark:text-white/50", "text-[0.75rem]", "mb-0"], ["type", "button", 1, "ti-btn", "ti-btn-outline-secondary", "!py-1", "!px-2", "!text-[0.75rem]", 3, "click"], [1, "ri-upload-cloud-line"], [1, "grid", "grid-cols-12", "gap-4", "mb-5"], [1, "xl:col-span-4", "col-span-12"], [1, "text-[0.75rem]", "text-[#8c9097]", "dark:text-white/50", "mb-1", "block"], ["type", "date", 1, "form-control", "w-full", "rounded-md", "border", "border-defaultborder", "px-3", "py-2", "text-[0.85rem]", 3, "ngModelChange", "ngModel"], [1, "xl:col-span-4", "col-span-12", "flex", "items-end"], ["type", "button", 1, "ti-btn", "bg-primary", "text-white", "!py-2", "!px-4", "!text-[0.85rem]", "w-full", 3, "click"], [1, "p-4", "rounded-md", "bg-primary/10", "border", "border-primary/10", "h-full"], [1, "text-[0.75rem]", "text-[#8c9097]", "mb-1"], [1, "font-semibold", "text-primary", "mb-0"], [1, "text-[0.75rem]", "text-[#8c9097]"], [1, "p-4", "rounded-md", "bg-info/10", "border", "border-info/10", "h-full"], [1, "font-semibold", "text-info", "mb-0"], [1, "p-4", "rounded-md", "bg-success/10", "border", "border-success/10", "h-full"], [1, "font-semibold", "text-success", "mb-0"], [1, "peak-non-peak-chart", "rounded-md", "border", "border-dashed", "border-defaultborder", "bg-light/30", "p-3", "dark:border-defaultborder/10", "dark:bg-black/10"], [1, "peak-non-peak-scroll", "overflow-x-hidden"], [3, "series", "chart", "xaxis", "yaxis", "stroke", "dataLabels", "colors", "grid", "legend", "markers", "tooltip", 4, "ngIf"], ["id", "energyConsumption", 1, "chart-container"], [3, "series", "chart", "dataLabels", "plotOptions", "yaxis", "xaxis", "legend", "colors", "grid", "fill", "tooltip", 4, "ngIf"], [1, "xxl:col-span-3", "xl:col-span-12", "col-span-12"], [1, "grid", "grid-cols-12", "gap-6"], [1, "xxl:col-span-12", "xl:col-span-6", "col-span-12"], [1, "box-body", "!py-3"], [1, "monthly-device-report-chart"], [3, "series", "chart", "colors", "labels", "legend", "stroke", "tooltip", "plotOptions", "dataLabels", 4, "ngIf"], [1, "monthly-device-report-list", "border-t", "border-dashed", "dark:border-defaultborder/10"], ["class", "col !p-0", 4, "ngFor", "ngForOf"], [3, "series", "chart", "xaxis", "yaxis", "stroke", "dataLabels", "colors", "grid", "legend", "markers", "tooltip"], [3, "series", "chart", "dataLabels", "plotOptions", "yaxis", "xaxis", "legend", "colors", "grid", "fill", "tooltip"], [3, "series", "chart", "colors", "labels", "legend", "stroke", "tooltip", "plotOptions", "dataLabels"], [1, "col", "!p-0"], [1, "p-[0.95rem]", "text-center", "border-e", "border-dashed", "dark:border-defaultborder/10"], [1, "text-[#8c9097]", "dark:text-white/50", "text-[0.75rem]", "mb-1", "inline-block"], [1, "text-[1rem]", "font-semibold"], [1, "text-[0.7rem]", "text-[#8c9097]"]], template: function CrmComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 1)(1, "div", 2)(2, "div")(3, "p", 3);
        \u0275\u0275text(4);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(5, "div", 4)(6, "button", 5);
        \u0275\u0275listener("click", function CrmComponent_Template_button_click_6_listener() {
          return ctx.exportEnergyConsumptionCsv();
        });
        \u0275\u0275element(7, "i", 6);
        \u0275\u0275text(8, " Export Consumption CSV ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275template(9, CrmComponent_div_9_Template, 34, 0, "div", 7)(10, CrmComponent_div_10_Template, 5, 0, "div", 8)(11, CrmComponent_div_11_Template, 4, 1, "div", 9)(12, CrmComponent_div_12_Template, 182, 26, "div", 10);
        \u0275\u0275elementEnd();
      }
      if (rf & 2) {
        \u0275\u0275advance(4);
        \u0275\u0275textInterpolate1(" Welcome back, ", ctx.currentUser == null ? null : ctx.currentUser.name, " ! ");
        \u0275\u0275advance(5);
      ...
      ChartComponent,
      SharedModule
    ], styles: ['\n\n.peak-non-peak-scroll[_ngcontent-%COMP%] {\n  overscroll-behavior: contain;\n}\n.dashboard-loader[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 1rem;\n  margin-bottom: 1.5rem;\n}\n.dashboard-loader-panel[_ngcontent-%COMP%], .dashboard-loader-card[_ngcontent-%COMP%], .dashboard-refresh-loader[_ngcontent-%COMP%] {\n  border: 1px solid rgba(140, 144, 151, 0.22);\n  background: #fff;\n  box-shadow: 0 0.5rem 1.5rem rgba(15, 23, 42, 0.04);\n}\n.dashboard-loader-panel[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 1rem;\n  padding: 1.25rem;\n  border-radius: 0.5rem;\n}\n.energy-loader[_ngcontent-%COMP%] {\n  position: relative;\n  display: grid;\n  width: 5.5rem;\n  min-width: 5.5rem;\n  height: 5.5rem;\n  place-items: center;\n}\n.energy-loader-ring[_ngcontent-%COMP%] {\n  position: absolute;\n  inset: 0.35rem;\n  border: 0.25rem solid rgba(35, 183, 229, 0.16);\n  border-top-color: rgb(132, 90, 223);\n  border-right-color: rgb(35, 183, 229);\n  border-radius: 50%;\n  animation: _ngcontent-%COMP%_energy-loader-spin 1.1s linear infinite;\n}\n.energy-loader-core[_ngcontent-%COMP%] {\n  position: relative;\n  z-index: 1;\n  display: inline-flex;\n  align-items: center;\n  justify-content: center;\n  width: 3.25rem;\n  height: 3.25rem;\n  border: 1px solid rgba(132, 90, 223, 0.22);\n  border-radius: 50%;\n  background: rgba(132, 90, 223, 0.08);\n  color: rgb(132, 90, 223);\n  font-size: 1.45rem;\n  animation: _ngcontent-%COMP%_energy-loader-pulse 1.4s ease-in-out infinite;\n}\n.energy-loader-bar[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 0.35rem;\n  width: 0.35rem;\n  border-radius: 999px;\n  background: rgb(35, 183, 229);\n  animation: _ngcontent-%COMP%_energy-loader-bars 0.9s ease-in-out infinite;\n}\n.energy-loader-bar-one[_ngcontent-%COMP%] {\n  height: 1.1rem;\n  left: 1.55rem;\n}\n.energy-loader-bar-two[_ngcontent-%COMP%] {\n  height: 1.6rem;\n  background: rgb(38, 191, 148);\n  animation-delay: 0.12s;\n}\n.energy-loader-bar-three[_ngcontent-%COMP%] {\n  height: 0.9rem;\n  right: 1.55rem;\n  background: rgb(245, 184, 73);\n  animation-delay: 0.24s;\n}\n.dashboard-loader-copy[_ngcontent-%COMP%] {\n  flex: 1;\n  min-width: 0;\n}\n.dashboard-loader-progress[_ngcontent-%COMP%] {\n  position: relative;\n  height: 0.35rem;\n  overflow: hidden;\n  border-radius: 999px;\n  background: rgba(140, 144, 151, 0.16);\n}\n.dashboard-loader-progress[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  position: absolute;\n  inset-block: 0;\n  width: 42%;\n  border-radius: inherit;\n  background:\n    linear-gradient(\n      90deg,\n      rgb(132, 90, 223),\n      rgb(35, 183, 229),\n      rgb(38, 191, 148));\n  animation: _ngcontent-%COMP%_dashboard-loader-sweep 1.2s ease-in-out infinite;\n}\n.dashboard-loader-grid[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(12, minmax(0, 1fr));\n  gap: 1rem;\n}\n.dashboard-loader-card[_ngcontent-%COMP%] {\n  display: grid;\n  grid-column: span 3;\n  gap: 0.75rem;\n  min-height: 9rem;\n  padding: 1rem;\n  border-radius: 0.5rem;\n}\n.dashboard-loader-card-wide[_ngcontent-%COMP%] {\n  grid-column: span 6;\n}\n.dashboard-loader-card-chart[_ngcontent-%COMP%] {\n  grid-column: span 12;\n  min-height: 13rem;\n}\n.dashboard-loader-card[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  display: block;\n  overflow: hidden;\n  border-radius: 999px;\n  background: rgba(140, 144, 151, 0.16);\n}\n.dashboard-loader-card[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]::after {\n  display: block;\n  width: 45%;\n  height: 100%;\n  content: "";\n  background:\n    linear-gradient(\n      90deg,\n      transparent,\n      rgba(255, 255, 255, 0.78),\n      transparent);\n  animation: _ngcontent-%COMP%_dashboard-loader-shimmer 1.25s ease-in-out infinite;\n}\n.dashboard-loader-card[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]:nth-child(1) {\n  width: 42%;\n  height: 0.75rem;\n}\n.dashboard-loader-card[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]:nth-child(2) {\n  width: 72%;\n  height: 2.4rem;\n}\n.dashboard-loader-card[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]:nth-child(3) {\n  width: 58%;\n  height: 0.75rem;\n}\n.dashboard-loader-card-chart[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  border-radius: 0.35rem;\n}\n.dashboard-loader-card-chart[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]:nth-child(2) {\n  align-self: end;\n  width: 100%;\n  height: 6rem;\n}\n.dashboard-loader-card-chart[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]:nth-child(4) {\n  width: 86%;\n  height: 0.75rem;\n}\n.dashboard-refresh-loader[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 0.85rem;\n  margin-bottom: 1rem;\n  padding: 0.75rem 1rem;\n  border-radius: 0.5rem;\n  color: #536485;\n  font-size: 0.8125rem;\n  font-weight: 600;\n}\n.dashboard-refresh-loader[_ngcontent-%COMP%]   .dashboard-loader-progress[_ngcontent-%COMP%] {\n  flex: 1;\n}\n.dark[_nghost-%COMP%]   .dashboard-loader-panel[_ngcontent-%COMP%], .dark   [_nghost-%COMP%]   .dashboard-loader-panel[_ngcontent-%COMP%], .dark[_nghost-%COMP%]   .dashboard-loader-card[_ngcontent-%COMP%], .dark   [_nghost-%COMP%]   .dashboard-loader-card[_ngcontent-%COMP%], .dark[_nghost-%COMP%]   .dashboard-refresh-loader[_ngcontent-%COMP%], .dark   [_nghost-%COMP%]   .dashboard-refresh-loader[_ngcontent-%COMP%] {\n  border-color: rgba(255, 255, 255, 0.1);\n  background: rgba(0, 0, 0, 0.16);\n}\n.dark[_nghost-%COMP%]   .dashboard-loader-card[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]::after, .dark   [_nghost-%COMP%]   .dashboard-loader-card[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]::after {\n  background:\n    linear-gradient(\n      90deg,\n      transparent,\n      rgba(255, 255, 255, 0.18),\n      transparent);\n}\n@keyframes _ngcontent-%COMP%_energy-loader-spin {\n  to {\n    transform: rotate(360deg);\n  }\n}\n@keyframes _ngcontent-%COMP%_energy-loader-pulse {\n  0%, 100% {\n    transform: scale(1);\n  }\n  50% {\n    transform: scale(1.06);\n  }\n}\n@keyframes _ngcontent-%COMP%_energy-loader-bars {\n  0%, 100% {\n    transform: scaleY(0.55);\n    opacity: 0.55;\n  }\n  50% {\n    transform: scaleY(1);\n    opacity: 1;\n  }\n}\n@keyframes _ngcontent-%COMP%_dashboard-loader-sweep {\n  0% {\n    transform: translateX(-110%);\n  }\n  100% {\n    transform: translateX(250%);\n  }\n}\n@keyframes _ngcontent-%COMP%_dashboard-loader-shimmer {\n  0% {\n    transform: translateX(-120%);\n  }\n  100% {\n    transform: translateX(260%);\n  }\n}\n@media (max-width: 991.98px) {\n  .dashboard-loader-card[_ngcontent-%COMP%], .dashboard-loader-card-wide[_ngcontent-%COMP%] {\n    grid-column: span 6;\n  }\n}\n@media (max-width: 575.98px) {\n  .dashboard-loader-panel[_ngcontent-%COMP%] {\n    align-items: flex-start;\n  }\n  .energy-loader[_ngcontent-%COMP%] {\n    width: 4.75rem;\n    min-width: 4.75rem;\n    height: 4.75rem;\n  }\n  .dashboard-loader-card[_ngcontent-%COMP%], .dashboard-loader-card-wide[_ngcontent-%COMP%], .dashboard-loader-card-chart[_ngcontent-%COMP%] {\n    grid-column: span 12;\n  }\n}\n.monthly-device-report-chart[_ngcontent-%COMP%] {\n  display: flex;\n  min-height: 13.75rem;\n  align-items: center;\n  justify-content: center;\n}\n.monthly-device-report-chart[_ngcontent-%COMP%]   apx-chart[_ngcontent-%COMP%] {\n  display: block;\n  width: 100%;\n  max-width: 16rem;\n}\n.monthly-device-report-list[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: repeat(auto-fit, minmax(7rem, 1fr));\n}\n/*# sourceMappingURL=crm.component.css.map */'] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CrmComponent, { className: "CrmComponent", filePath: "src\\app\\components\\dashboards\\crm\\crm.component.ts", lineNumber: 89 });
})();
export {
  CrmComponent
};
...
apexcharts/dist/apexcharts.common.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-754G7X2O.js.map
