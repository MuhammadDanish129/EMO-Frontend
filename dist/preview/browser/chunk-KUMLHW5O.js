...
function AssignTenantComponent_ng_container_23_div_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("items", ctx_r1.genders)("enableSearch", true);
...
function AssignTenantComponent_ng_container_23_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()()();
    \u0275\u0275template(13, AssignTenantComponent_ng_container_23_div_13_Template, 2, 3, "div", 30)(14, AssignTenantComponent_ng_container_23_div_14_Template, 51, 23, "div", 31);
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
...
var AssignTenantComponent = class _AssignTenantComponent {
  ...
  constructor(router, route, userService, tenantService, managementService, toaster) {
    this.router = router;
    this.route = route;
  ...
  ngOnInit() {
    return __async(this, null, function* () {
      const stateOfficeIds = Array.isArray(history.state?.officeIds) ? history.state.officeIds : [];
      const queryOfficeIds = (this.route.snapshot.queryParamMap.get("officeIds") || "").split(",").map((id) => id.trim()).filter(Boolean);
  ...
  static {
    this.\u0275fac = function AssignTenantComponent_Factory(t) {
      return new (t || _AssignTenantComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(UserService), \u0275\u0275directiveInject(TenantService), \u0275\u0275directiveInject(ManagementService), \u0275\u0275directiveInject(ToastrService));
    };
  }
  static {
...
//# sourceMappingURL=chunk-KUMLHW5O.js.map
