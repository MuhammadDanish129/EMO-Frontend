...
function CrmComponent_div_26_aside_222_div_13_tr_11_div_16_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 144)(1, "button", 145);
    \u0275\u0275listener("click", function CrmComponent_div_26_aside_222_div_13_tr_11_div_16_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r5);
      const item_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r0 = \u0275\u0275nextContext(4);
      return \u0275\u0275resetView(ctx_r0.sendIdleApplianceCommand(item_r6, "OFF"));
    });
    \u0275\u0275element(2, "i", 146);
    \u0275\u0275text(3, " Turn off");
    \u0275\u0275elementEnd()();
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance();
    \u0275\u0275property("disabled", !ctx_r0.canControlIdleAppliance(item_r6));
  }
}
function CrmComponent_div_26_aside_222_div_13_tr_11_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
...
function CrmComponent_div_26_aside_222_div_13_tr_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "div", 140)(3, "span", 141);
    \u0275\u0275element(4, "i", 142);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "td", 138);
    \u0275\u0275template(16, CrmComponent_div_26_aside_222_div_13_tr_11_div_16_Template, 4, 1, "div", 143)(17, CrmComponent_div_26_aside_222_div_13_tr_11_ng_template_17_Template, 3, 0, "ng-template", null, 6, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const item_r6 = ctx.$implicit;
    const sendingIdleCommand_r7 = \u0275\u0275reference(18);
    const ctx_r0 = \u0275\u0275nextContext(4);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(item_r6.applianceName || item_r6.sensorName || "Idle appliance");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r6.message || item_r6.action || "Standby usage detected");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(item_r6.sensorName || "Unnamed sensor");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r6.utilityName || "Utility not assigned");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !ctx_r0.isIdleApplianceCommanding(item_r6))("ngIfElse", sendingIdleCommand_r7);
  }
}
function CrmComponent_div_26_aside_222_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7, "Sensor");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "th", 138);
    \u0275\u0275text(9, "Action");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "tbody");
    \u0275\u0275template(11, CrmComponent_div_26_aside_222_div_13_tr_11_Template, 19, 6, "tr", 139);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function CrmComponent_div_26_aside_222_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
...
function CrmComponent_div_26_aside_222_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(13, CrmComponent_div_26_aside_222_div_13_Template, 12, 1, "div", 135)(14, CrmComponent_div_26_aside_222_ng_template_14_Template, 7, 0, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const idleAlerts_r8 = ctx.ngIf;
    const noIdleAppliances_r9 = \u0275\u0275reference(15);
    \u0275\u0275advance(11);
...
function CrmComponent_div_26_div_287_article_1_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, CrmComponent_div_26_div_287_article_1_div_11_span_1_Template, 3, 1, "span", 161)(2, CrmComponent_div_26_div_287_article_1_div_11_span_2_Template, 3, 1, "span", 161)(3, CrmComponent_div_26_div_287_article_1_div_11_span_3_Template, 3, 1, "span", 161);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function CrmComponent_div_26_div_287_article_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "article", 154)(1, "span", 155);
    \u0275\u0275element(2, "i");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 156)(4, "div", 157)(5, "strong");
    \u0275\u0275text(6);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "span");
    \u0275\u0275text(8);
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275template(11, CrmComponent_div_26_div_287_article_1_div_11_Template, 4, 3, "div", 158)(12, CrmComponent_div_26_div_287_article_1_div_12_Template, 4, 1, "div", 159);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function CrmComponent_div_26_div_287_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, CrmComponent_div_26_div_287_article_1_Template, 13, 11, "article", 153);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function CrmComponent_div_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(222, CrmComponent_div_26_aside_222_Template, 16, 3, "aside", 95);
    \u0275\u0275pipe(223, "async");
    ...
    \u0275\u0275elementStart(225, "div", 97)(226, "span", 66);
    \u0275\u0275element(227, "i", 98);
    \u0275\u0275elementEnd();
    ...
    return {
      ...
      xaxis: {
        ...
        labels: {
          ...
          formatter: (_value, timestamp) => timestamp ? this.formatLiveChartTime(new Date(timestamp)) : ""
        },
      ...
      tooltip: {
        x: {
          formatter: (value) => this.formatLiveChartTime(new Date(value))
        },
...
//# sourceMappingURL=chunk-XIBHGIP3.js.map
