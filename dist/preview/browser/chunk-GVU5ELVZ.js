...
} from "./chunk-6JBT53SG.js";
import "./chunk-ZXYBBVOW.js";
import {
  AuthService
...
var ResizeService = class _ResizeService {
  ...
  static \u0275fac = function ResizeService_Factory(t) {
    return new (t || _ResizeService)(\u0275\u0275inject(WINDOW), \u0275\u0275inject(DOCUMENT), \u0275\u0275inject(PLATFORM_ID));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
function LoginComponent_For_31_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 27)(1, "div", 28)(2, "div", 29)(3, "div")(4, "div", 30)(5, "span", 31);
    \u0275\u0275element(6, "i");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "h6", 32);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275classMapInterpolate1("authentication-slide-icon ", slide_r1.tone, "");
    \u0275\u0275advance();
    \u0275\u0275classMap(slide_r1.icon);
    \u0275\u0275advance(2);
...
function LoginComponent_For_31_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275template(1, LoginComponent_For_31_ng_template_1_Template, 11, 8, "ng-template", 26);
    \u0275\u0275elementContainerEnd();
  }
}
var LoginComponent = class _LoginComponent {
      ...
      this.authservice.login(username, password).subscribe({
        next: (res) => {
          ...
          if (res?.success) {
            ...
            const redirectUrl = userTypeLevel === 0 ? "/dashboard/system-dashboard" : "/dashboard";
        ...
        error: (err) => {
          console.log(err);
          const message = err?.error?.remarks || err?.message || "Server error occurred";
  ...
  static {
    this.\u0275fac = function LoginComponent_Factory(t) {
      return new (t || _LoginComponent)(\u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(Renderer2), \u0275\u0275directiveInject(FirebaseService), \u0275\u0275directiveInject(ToastrService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], standalone: true, features: [\u0275\u0275ProvidersFeature([FirebaseService, { provide: ToastrService, useClass: ToastrService }]), \u0275\u0275StandaloneFeature], decls: 33, vars: 7, consts: [[1, "grid", "grid-cols-12", "authentication", "mx-0", "min-h-screen", "text-defaulttextcolor", "text-defaultsize"], [1, "xxl:col-span-7", "xl:col-span-7", "lg:col-span-6", "col-span-12", "flex", "items-center", "justify-center", "px-4"], [1, "w-full", "max-w-[600px]"], [1, "p-[3rem]"], [1, "mb-4"], ["aria-label", "anchor", "routerLink", "/dashboard/crm"], ["src", "./assets/images/brand-logos/desktop-logo.png", "alt", "", 1, "w-10"], [1, "h5", "font-semibold", "mb-2"], [3, "ngSubmit", "formGroup"], [1, "grid", "grid-cols-12", "gap-y-4"], [1, "xl:col-span-12", "col-span-12", "mt-0"], ["for", "signin-username", 1, "form-label", "text-default"], ["type", "text", "id", "signin-username", "placeholder", "user name", "formControlName", "username", 1, "form-control", "form-control-lg", "w-full", "!rounded-md"], [1, "xl:col-span-12", "col-span-12", "mb-4"], ["for", "signin-password", 1, "form-label", "text-default", "block"], [1, "input-group"], ["id", "signin-password", "placeholder", "password", "formControlName", "password", "autocomplete", "off", 1, "form-control", "form-control-lg", "!rounded-e-none", 3, "type"], ["aria-label", "button", "type", "button", 1, "ti-btn", "ti-btn-light", "!rounded-s-none", "!mb-0", 3, "click"], [1, "xl:col-span-12", "col-span-12", "grid", "mt-2"], ["type", "submit", 1, "ti-btn", "ti-btn-lg", "bg-primary", "text-white", "!font-medium", "dark:border-defaultborder/10"], [1, "xxl:col-span-5", "xl:col-span-5", "lg:col-span-5", "col-span-12", "xl:block", "hidden", "px-0"], [1, "authentication-cover"], [1, "aunthentication-cover-content", "rounded"], [1, "swiper", "keyboard-control", "authentication"], [3, "options", "dir"], [1, "swiper-pagination"], ["carouselSlide", ""], [1, "swiper-wrapper"], [1, "swiper-slide"], [1, "text-white", "text-center", "p-[3rem]", "flex", "items-center", "justify-center"], [1, "mb-[3rem]"], ["aria-hidden", "true"], [1, "font-semibold", "text-[1rem]"], [1, "font-normal", "text-[.875rem]", "opacity-[0.7]"]], template: function LoginComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275text(24, " Sign In ");
        \u0275\u0275elementEnd()()()()()()();
        \u0275\u0275elementStart(25, "div", 20)(26, "div", 21)(27, "div", 22)(28, "div", 23)(29, "owl-carousel-o", 24);
        \u0275\u0275repeaterCreate(30, LoginComponent_For_31_Template, 2, 0, "ng-container", null, \u0275\u0275repeaterTrackByIndex);
        \u0275\u0275elementEnd();
        \u0275\u0275element(32, "div", 25);
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(2);
        \u0275\u0275classMapInterpolate1("ri-eye-", ctx.toggleClass, " align-middle");
        \u0275\u0275advance(8);
        \u0275\u0275property("options", ctx.customOptions)("dir", ctx.customOptions.rtl ? "rtl" : "ltr");
        \u0275\u0275advance();
    ...
    ], styles: ['\n\n  .firebase {\n  width: 30px;\n  height: 30px;\n}\n  .rounded-lg {\n  width: 120px;\n  justify-content: center;\n  margin: auto;\n  border-radius: 0.75rem;\n}\n.authentication-slide-icon[_ngcontent-%COMP%] {\n  position: relative;\n  display: inline-flex;\n  width: 8.75rem;\n  height: 8.75rem;\n  align-items: center;\n  justify-content: center;\n  border: 1px solid rgba(255, 255, 255, 0.28);\n  border-radius: 50%;\n  background:\n    radial-gradient(\n      circle at 35% 28%,\n      rgba(255, 255, 255, 0.34),\n      transparent 34%),\n    rgba(255, 255, 255, 0.14);\n  box-shadow: 0 1.25rem 3.5rem rgba(0, 0, 0, 0.22), inset 0 0 2.5rem rgba(255, 255, 255, 0.12);\n  color: #ffffff;\n}\n.authentication-slide-icon[_ngcontent-%COMP%]::before, .authentication-slide-icon[_ngcontent-%COMP%]::after {\n  content: "";\n  position: absolute;\n  border-radius: 50%;\n  pointer-events: none;\n}\n.authentication-slide-icon[_ngcontent-%COMP%]::before {\n  inset: -0.75rem;\n  border: 1px solid rgba(255, 255, 255, 0.12);\n}\n.authentication-slide-icon[_ngcontent-%COMP%]::after {\n  inset: 1rem;\n  background: rgba(255, 255, 255, 0.1);\n}\n.authentication-slide-icon[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  position: relative;\n  z-index: 1;\n  font-size: 4.25rem;\n  line-height: 1;\n}\n.authentication-slide-icon.energy[_ngcontent-%COMP%] {\n  color: #f8ff9c;\n}\n.authentication-slide-icon.facility[_ngcontent-%COMP%] {\n  color: #b8f7ff;\n}\n.authentication-slide-icon.dashboard[_ngcontent-%COMP%] {\n  color: #d8c6ff;\n}\n/*# sourceMappingURL=login.component.css.map */'] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src\\app\\authentication\\login\\login.component.ts", lineNumber: 29 });
})();
export {
  LoginComponent
};
//# sourceMappingURL=chunk-GVU5ELVZ.js.map
