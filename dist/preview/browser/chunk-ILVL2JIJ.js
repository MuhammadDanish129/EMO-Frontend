    ...
    children: [
      {
        ...
        loadComponent: () => import("./chunk-VXLCVCAW.js").then((m) => m.BusinessManagementComponent),
      ...
      {
        path: "add-business",
        loadComponent: () => import("./chunk-X57BDEKD.js").then((m) => m.BusinessManagementAddUpdateComponent),
        providers: [provideNativeDateAdapter()]
      },
      {
        path: "building-management",
        loadComponent: () => import("./chunk-IYF6RJ6T.js").then((m) => m.BuildingManagementComponent),
        providers: [provideNativeDateAdapter()]
      },
      {
        path: "add-building",
        loadComponent: () => import("./chunk-MZRC5YQI.js").then((m) => m.BuildingManagementAddUpdateComponent),
        providers: [provideNativeDateAdapter()]
      },
      {
        path: "floor-management",
        loadComponent: () => import("./chunk-UA2BWEHX.js").then((m) => m.FloorManagementComponent),
        providers: [provideNativeDateAdapter()]
      },
      {
        path: "section-management",
        loadComponent: () => import("./chunk-VCIJLHKG.js").then((m) => m.SectionManagementComponent),
        providers: [provideNativeDateAdapter()]
      },
      {
        path: "office-management",
        loadComponent: () => import("./chunk-LGX3IFXW.js").then((m) => m.OfficeManagementComponent),
        providers: [provideNativeDateAdapter()]
      },
      {
        path: "tenant-office-assignment",
        loadComponent: () => import("./chunk-U7QXJNZA.js").then((m) => m.TenantOfficeAssignmentComponent),
        providers: [provideNativeDateAdapter()]
      },
      {
      ...
      {
        path: "assign-tenant",
        loadComponent: () => import("./chunk-HFYPM6OZ.js").then((m) => m.AssignTenantComponent),
        providers: [provideNativeDateAdapter()]
      },
      {
...
//# sourceMappingURL=chunk-ILVL2JIJ.js.map
