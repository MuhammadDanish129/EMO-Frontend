...
// src/app/shared/services/guards/auth.guard.ts
...
var App_Route = [
  ...
  {
    path: "auth/login",
    loadComponent: () => import("./chunk-GVU5ELVZ.js").then((m) => m.LoginComponent)
  },
  {
    path: "",
    ...
    children: [
      {
        ...
        loadChildren: () => import("./chunk-TH3J7I7L.js").then((m) => m.liveConsumption)
        // canLoad: [AuthGuard],         // Ensures lazy-loaded module is protected
      }
    ]
  },
  {
    ...
    children: [
      {
        path: "",
        loadChildren: () => import("./chunk-QGQYE4RY.js").then((m) => m.management)
        // canLoad: [AuthGuard],         // Ensures lazy-loaded module is protected
      }
    ]
  },
  ...
  },
  {
    ...
    children: [
      {
        path: "",
        loadChildren: () => import("./chunk-C3KMTNBQ.js").then((m) => m.device)
        // canLoad: [AuthGuard],         // Ensures lazy-loaded module is protected
      }
    ]
  },
  {
    ...
    canActivate: [AuthGuard],
    canActivateChild: [AuthGuard],
    children: [{ path: "", loadChildren: () => import("./chunk-O2QKOGIR.js").then((m) => m.settings) }]
  },
...
// src/app/shared/services/auth.utils.ts
var AuthUtils = class {
  /**
   * Constructor
   */
...
var AuthInterceptor = class _AuthInterceptor {
  constructor(_authService, _toaster) {
  ...
  static {
    this.\u0275fac = function AuthInterceptor_Factory(t) {
      return new (t || _AuthInterceptor)(\u0275\u0275inject(AuthService), \u0275\u0275inject(ToastrService));
    };
  }
  static {
...
var chunkLoadErrorPattern = /Failed to fetch dynamically imported module|Loading chunk|Importing a module script failed|error loading dynamically imported module/i;
var chunkLoadRetryKey = "emo.chunk-load-retry-url";
...
var AppComponent = class _AppComponent {
  ...
  static {
    ...
    }, dependencies: [CommonModule, RouterOutlet, HttpClientModule], data: { animation: [] } });
  }
};
(() => {
